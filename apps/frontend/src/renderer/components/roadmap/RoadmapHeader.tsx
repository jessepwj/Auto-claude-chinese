              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  ...
                  >
                    ...
                    {t('roadmap:header.competitorAnalysisBadge')}
                  </Badge>
                </TooltipTrigger>
                <TooltipContent className="max-w-md">
                  <div className="space-y-2">
                    <div className="font-semibold">{t('roadmap:header.competitorAnalysisTooltipTitle')}</div>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="outline" size="sm" onClick={onAddFeature}>
                ...
                {t('roadmap:header.addFeatureButton')}
              </Button>
            </TooltipTrigger>
      ...
      {roadmap.targetAudience && (
        <div className="mt-4 flex items-center gap-4 text-sm">
          <div className="flex items-center gap-2">
            ...
            <span className="text-muted-foreground">{t('roadmap:header.targetLabel')}</span>
            ...
            <Tooltip>
              ...
              <TooltipContent className="max-w-md">
                <div className="space-y-1">
                  <div className="font-semibold mb-2">{t('roadmap:header.secondaryPersonasTitle')}</div>
      ...
      <div className="mt-4 flex items-center gap-6">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm">
            ...
            <span className="text-muted-foreground"> {t('roadmap:header.featuresLabel')}</span>
          </span>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-sm">
            <span className="font-semibold">{roadmap.phases.length}</span>
            <span className="text-muted-foreground"> {t('roadmap:header.phasesLabel')}</span>
          </span>
        </div>
